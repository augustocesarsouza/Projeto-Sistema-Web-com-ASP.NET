...
using Projeto_Sistema_Web_com_ASP.NET.Models.Enums;

namespace Projeto_Sistema_Web_com_ASP.NET.Data
{
    public class SeedingService
    {
        private Projeto_Sistema_Web_com_ASPNETContext _context;

        public SeedingService(Projeto_Sistema_Web_com_ASPNETContext context)
        {
            _context = context;
        }
